$(function(){
	...
	var movingDistance	    = 200;//每次移动的距离
	var curWidth			= 200;//当前中间li的宽度为350px
	var curHeight         =480;//当前中间li的高度未312  
	var curImgWidth  =200;
	...
	$container.css('width', (($panels[0].offsetWidth+60) * $panels.length) + 60 ).css('left','0');//计算容器的总的宽度 PS：25为margin值 offsetWidth
